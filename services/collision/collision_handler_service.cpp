#include "collision_handler_service.h"
...
bool CollisionHandlerService::BoundingBoxIntersect(Shell* shell, Barracks* barracks) {
    ...
    // This is caused by the fact that when handling the collision, the bounding box should be bigger.
    glm::vec3 buildingOffset = glm::vec3(0.35f, 0.0f, 0.35f);
